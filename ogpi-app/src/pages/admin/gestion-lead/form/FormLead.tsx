    ...
    try {
      ...
      if (currentStep === "offre") {
        ...
        const techFinPayload = {
          ...
          montantOffre: formTechFin.montantOffre || formTechFin.budget || 0,
          montantChargeAnnexe: formTechFin.montantChargeAnnexe || 0,
          montantAvecChargeAnnexe: (formTechFin.montantOffre || formTechFin.budget || 0) + (formTechFin.montantChargeAnnexe || 0),
